...
if [ -e /usr/bin/cvlc ]; then
    ...
    zenity --info --text="Hai bisogno di installare VLC o CVL"
    exit 1
fi
...
function usage {
    ...
    echo -e "\t rai1, rai2, rai3, raistoria, rainews24, raisport, raiedu1"
...
function gui {
	...
	false "Rai2" "Variety" \
	false "Rai3" "Variety" \
	false "RaiStoria" "Educational" \
	false "Rainews24" "Information" \
	false "Raisport" "Sport" \
	false "Raiedu1" "Educational" \
	...
	"RaiStoria" ) url="http://mediapolis.rai.it/relinker/relinkerServlet.htm?cont=24269";;
